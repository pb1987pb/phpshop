...
.form_yuyue .shenqin {display:block;height:45px;text-align:center;line-height:45px;color:white;background-color:#363942;margin-left:80px;}
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="/"><img src="/Public/Home/images/logo.png" alt="京西商城"></a></h2>
                        <?php if(myorder == 'mycar') $flow = 'flow1'; else if(myorder == 'myorder') $flow = 'flow2'; else $flow = 'flow3'; ?>
			<div class="flow fr <?php echo $flow;?>">
				<ul>
                                    <li class="<?php echo myorder=='mycar'?'cur':''?>">1.我的购物车</li>
					<li class="<?php echo myorder=='myorder'?'cur':''?>">2.填写核对订单信息</li>
					<li class="<?php echo myorder=='copmorder'?'cur':''?>">3.成功提交订单</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="fillin w990 bc mt15">
            <form  action="/index.php/home/Order/add/ids/5,7"  method="post" name="orderform" >
                
                <input type="hidden" name="ids" value="<?php echo $ids;?>">
                 <input type="hidden" name="cur_name" value="">
                 <input type="hidden" name="cur_tel" value="">
                 <input type="hidden" name="cur_province" value="">
                 <input type="hidden" name="cur_city" value="">
                 <input type="hidden" name="cur_area" value="">
                   <input type="hidden" name="cur_address" value="">
			...
			<!-- 收货人信息  start-->
                         ...
                         <ul class="address_wrap" id="address_wrap">
                          ...
                          <div class="add_new">
<p id="zengjiaadd"><img src="/Public/Home/images/add_new.png"/></p>
                          </div>
			...
			<!-- 商品清单 end -->
                        ...
                        <!-- 备注 end -->
                         ...
                         <!-- 支付 start -->
                             ...
                             <div class="tu f_left"><img src="/Public/Home/images/pay01.png"/></div></div>
	...
	<!-- 主体部分 end -->
        ...
        <div class="address_select" >
            ...
            <div class="xian_wrap"><img src="/Public/Home/images/xiexian.png"  class="xian"/></div>
   ...
   <p><input type="checkbox" name="is_default" value="是" {{if is_default=="是"}} checked {{/if}} >设置为默认地址</p> 
            ...
            {{each list as value}} 
                     <li data-id="{{value.id}}"  class="clear  {{value.curclass}}"
                         data-sign="{{value}}">
                             ...
                             <img src="/Public/Home/images/no_check.png" class="xianshi"/>
                              <img src="/Public/Home/images/check.png" class="yincang"/>
                         </div>
        ...
        <script type="text/javascript" src="/Public/Home/js/CityJs.js"></script>
         <script type="text/javascript" src="/Public/Home/js/layer-v3.0.3/layer/layer.js"></script>
         
             <script type="text/javascript" src="/Public/Home/js/template-web.js"></script>
...
function orderchck(){
 ...
 address = $mesf.shr_address ;
  ...
  if(valData(name,tel,province,city,area,address))
      {
          //验证通过
          $(':hidden[name="cur_name"]').val(name);
       $(':hidden[name="cur_tel"]').val(tel);
       $(':hidden[name="cur_province"]').val(province);
       $(':hidden[name="cur_city"]').val(city);
       $(':hidden[name="cur_area"]').val(area);
       $(':hidden[name="cur_address"]').val(address);
       // 提交表单
