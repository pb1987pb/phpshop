...
<!-- 综合区域 start 包括幻灯展示，商城快报 -->
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						...
						<li>
							<dl>
								<dt><a href="<?php echo U('Goods/detail?id='.$v['id']); ?>"><?php showImage($v['mid_logo']); ?></a></dt>
								<dd><a href="<?php echo U('Goods/detail?id='.$v['id']); ?>"><?php echo $v['goods_name']; ?></a></dd>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			<!-- 商品分类信息 start-->
			<div class="cate fl">
				<h2><?php echo $v['catename']; ?></h2>
				<div class="cate_wrap">
					<ul>
						<?php foreach ($v['nofloor'] as $k1 => $v1): ?>
						<li><a href=""><b>.</b><?php echo $v1['catename']; ?></a></li>
						<?php endforeach; ?>
					</ul>
			...
			<div class="goodslist fl">
				<h2>
					<?php foreach ($v['yesfloor'] as $k1 => $v1): ?>
					<span <?php if($k1==0) echo 'class="on"'; ?>><?php echo $v1['catename']; ?></span>
					<?php endforeach; ?>
				</h2>
				<div class="goodslist_wrap">
					...
					<div <?php if($k1 > 0) echo 'class="none"'; ?>>
						<ul>
							...
							<li>
								<dl>
									<dt><a href="<?php echo U('Goods/detail?id='.$v2['id']); ?>"><?php showImage($v2['mid_logo']); ?></a></dt>
									<dd><a href="<?php echo U('Goods/detail?id='.$v2['id']); ?>"><?php echo $v2['goods_name']; ?></a></dd>
