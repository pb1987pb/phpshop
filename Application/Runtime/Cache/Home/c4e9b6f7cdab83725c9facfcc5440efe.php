...
<link rel="stylesheet" href="/Public/Home/style/login.css" type="text/css">
				...
				<form action="#" method="post">
					...
					<ul>
						...
						<li class="checkcode">
							...
							<img style="cursor:pointer;" id="code" onclick="" src="<?php echo U('chkcode'); ?>" />
						</li>
	...
	<!-- 登录主体部分end -->
        ...
        <script>
            ...
            $(function(){
                ...
                // 验证码的改变
                $('#code').click(function(){
                    $(this).attr('src',"<?php echo U('chkcode'); ?>#'"+Math.random());
                });
                ...
                $('#login_btn').click(function(){
                    ...
                    $.ajax({
	type : "POST",
	url : "/index.php/Home/Member/ajaxLogin",
        data:$('form').serialize(),
	dataType : "json",
	success : function(data)
	{
          if(data.code==0){
              ...
              // 登录成功，那么这里就获取 cookie里面的值
            var cookieUrl=$.cookie("returnUrl");
            var callback="/";
             if(cookieUrl)
                 {
                  // 删除‘/’ 路径下的 名字是 returnUrl 的cookie
