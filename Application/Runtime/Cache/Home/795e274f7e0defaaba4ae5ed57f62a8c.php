...
<style>
    .num{position: absolute;left: 0;top: 0;border-radius: 50%;background-color: red;color: white;
        font-size: 14px;z-index: 1000000;width: 20px;height:20px;line-height: 20px;text-align: center;display: none;}
</style>
<!-- 头部 start -->
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			...
			<div class="cart fl">
				<dl>
					<dt>
						<a href="/index.php/Home/Cart/lst">去购物车结算</a>
						<b></b>
					</dt>
					<dd>
						<div class="prompt" id="goodcar">
			...
			<div class="category fl <?php if($_show_nav == 0) echo 'cat1'; ?>">
				...
				<div class="cat_bd <?php if($_show_nav == 0) echo 'none'; ?>"> 
					...
					<div class="cat <?php if($k==0) echo 'item1'; ?>">
						<h3><a href=""><?php echo $v['catename'];?></a> <b></b></h3>
						<div class="cat_detail none">
							<?php foreach ($v['children'] as $k1 => $v1): ?>
							<dl  class="<?php if($k1==0) echo 'dl_1st'; ?>">
								<dt><a href=""><?php echo $v1['catename'];?></a></dt>
								<dd>
									<?php foreach ($v1['children'] as $k2 => $v2): ?>
									<a href=""><?php echo $v2['catename'];?></a>
									<?php endforeach; ?>					
								</dd>
							</dl>
							<?php endforeach; ?>
...
//	dataType : "json",
	...
	success : function(data)
	{
            ...
            //这里购物车的信息我们最多显示 6条
              if(count>6){
                data=data.splice(0,6); //从第0个索引开始，取6个值
            }
          ...
          data.forEach(function(e,index){  
                               ...
                               html += "<tr>";
				html += '<td><img width="50" src="<?php echo $picView?>'+e.mid_logo+'" /></td>';
...
<!-- 商品页面主体 start -->
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：
			<a href="/">首页</a> > 
			<?php  $count = count($cateData); for($i=$count-1; $i>=0; $i--): ?>
				<a href=""><?php echo $cateData[$i]['catename']; ?></a> > 
			<?php endfor; ?>
			<?php echo $goodData['goods_name']; ?></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?php echo $goodData['goods_name']; ?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo $viewPath . $goodData['mbig_logo']; ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图,最大的图 class 和 rel属性不能更改 -->
							<?php showImage($goodData['big_logo']); ?>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<!-- 第一个是logo小图 ，这个图这里分别有4个尺寸 150 300 500 700(mbig)-->
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo $viewPath.$goodData['big_logo']; ?>',largeimage: '<?php echo $viewPath.$goodData['mbig_logo']; ?>'}"><?php showImage($goodData['sm_logo']); ?></a>
								</li>
								<!-- 循环相册中的图片，这里面的图片只要三个尺寸 50 350 650　-->
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?php echo $goodData['id']; ?></li>
						<li class="market_price"><span>市场价：</span><em>￥<?php echo $goodData['market_price']; ?>元</em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo $goodData['shop_price']; ?>元</strong></li>
						...
						<ul>
							...
							<li class="product">
								<dl>
									...
									<input <?php if($k1==0) echo 'checked="checked"'; ?> type="radio" name="goods_attr_ids[<?php echo $v1['attr_id'];?>]" value="<?php echo $v1['id']; ?>" />
											</a>
										<?php endforeach; ?>
									</dd>
								</dl>
							...
							<li>
								<dl>
									<dt>&nbsp;</dt>
									<dd>
										<input type="submit" value="" class="add_btn" id="add_btn"/>
									</dd>
								</dl>
							</li>
						</ul>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php foreach ($weiyiData as $k => $v): ?>
								<li><span><?php echo $v['attr_name']; ?>：</span><?php echo $v['attr_value']; ?></li>
								<?php endforeach; ?>
							</ul>
						</div>

						<div class="desc mt10"><?php echo $goodData['goods_desc']; ?></div>
					</div>
					<!-- 商品介绍 end -->
...
<script>
///index.php/Goods/displayHistory/id
// 记录浏览历史
$.ajax({
	type : "GET",
	url : "/index.php/Home/Goods/displayHistory/id/<?php echo $goodData['id']; ?>",
	dataType : "json",
	success : function(data)
	{
		...
		var html = "";
			...
			html += '<li><dl><dt><a href="/index.php/Goods/detail/id/'+e.id+'">';
                        html +='<img src="<?php echo $viewPath;?>'+e.mid_logo+'" />';
                        html += '</a></dt><dd><a href="index.php/Goods/detail/id/'+e.id+'">'+e.goods_name;
                        html += '</a></dd><dd><strong>￥'+e.shop_price+'</strong></dd></dl></li>';
		});
		// 放到 页面中
...
$.ajax({
	type : "GET",
	url : "/index.php/Home/Goods/ajaxGetPrice/id/<?php echo $goodData['id']; ?>",
//	dataType : "json",
	success : function(data)
	{
 ...
 $('#add_btn').click(function(){
	...
	success : function(data)
	{
          if(data.code==1){
              // 等于 0就是添加失败
             layer.msg('加入购物车成功');
              // 这里因为上面有一个购物车头部，所以这里加入成功，更新一下头部的购物车信息
              $('#num').text(data.count);
