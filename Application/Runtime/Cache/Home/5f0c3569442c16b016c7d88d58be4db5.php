	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="/"><img src="/Public/Home/images/logo.png" alt="京西商城"></a></h2>
                        <?php if(copmorder == 'mycar') $flow = 'flow1'; else if(copmorder == 'myorder') $flow = 'flow2'; else $flow = 'flow3'; ?>
			<div class="flow fr <?php echo $flow;?>">
				<ul>
                                    <li class="<?php echo copmorder=='mycar'?'cur':''?>">1.我的购物车</li>
					<li class="<?php echo copmorder=='myorder'?'cur':''?>">2.填写核对订单信息</li>
					<li class="<?php echo copmorder=='copmorder'?'cur':''?>">3.成功提交订单</li>
				</ul>
			</div>
		</div>
	</div>
