...
<link rel="stylesheet" href="/Public/Home/style/login.css" type="text/css">
	...
	<div class="login w990 bc mt10 regist">
		...
		<div class="login_bd">
			<div class="login_form fl">
                            <form action="/index.php/Home/Member/regist.html" method="post" onsubmit="return check()">
					<ul>
						<li>
							<label for="">用户名：</label>
						...
						<li class="checkcode">
							...
							<input type="text"  name="chkcode" />
                                                        <img style="cursor:pointer;" class="check" onclick="this.src='<?php echo U('chkcode'); ?>#'+Math.random();" src="<?php echo U('chkcode'); ?>" />
                                                        <span>看不清？<a href="javascript:;" class="huan">换一张</a></span>
						</li>
						<li>
							<label for="">&nbsp;</label>
	...
	<!-- 登录主体部分end -->
        <script>
            ...
            //切换验证码
            $('.huan').click(function(){
            $('.check').attr('src',$('.check').attr('src')+"#"+Math.random());
            });
